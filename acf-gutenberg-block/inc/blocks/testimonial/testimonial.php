...
$authorRole      = get_field( 'role' ) ?: 'Author role';
$image            = get_field( 'image' ) ?: 295;
$backgroundColor = get_field( 'background_color' );
$textColor       = get_field( 'text_color' );

// Build a valid style attribute for background and text colors.
$styles = array( 'background-color: ' . $backgroundColor, 'color: ' . $textColor );
...
<div class="<?php echo esc_attr( $className ); ?>" style="<?php echo esc_attr( $style ); ?>">
    <blockquote class="testimonial-blockquote">
        ...
        <span class="testimonial-role"><?php echo esc_html( $authorRole ); ?></span>
    </blockquote>
